...
(1, '蜂蜜蛋糕', '<p>吃起來醇厚綿潤，有著滿滿蛋香與濃厚到宛如蜂蜜的甜蜜香氣，不會乾口卡喉。</p>\r\n', 200, 1, '2020-11-27 05:31:38'),
(2, '提拉米蘇', '<p>是一種著名的義大利式蛋糕，它是由泡過咖啡或蘭姆酒的手指餅乾，加上一層馬斯卡彭起司、蛋黃及糖的混合物，然後再在蛋糕表面灑上一層可可粉而成，口感細膩飽滿，是一道老少皆宜的甜點。</p>\r\n', 350, 1, '2020-11-27 05:33:09'),
(3, '檸檬塔', '<p>是一道由麵粉、奶油與檸檬製成的西方甜食點心。改良後的版本是採用預烤法，先把塔皮單獨烤過後再把隔水加熱過的餡料置入，或者先把塔皮烤一陣子後再加上餡料一起烤，並且採用冰奶油作為塔皮的原料，如此就能全面保持塔皮的酥脆口感</p>\r\n', 320, 1, '2020-11-27 05:35:15');
...
(4, 'wen', 'a123', '$2y$10$XVmuag7jGbMJWKaMk2iEI.rAIMxwlwISqvzoAbIBB2vr6/7tiR6g6', 'a123@gmail.com', '女士', '062785123', '711', '台南市', '歸仁區', '長大路1號');
...
--
ALTER TABLE `users`
  MODIFY `user_sn` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '使用者編號', AUTO_INCREMENT=5;
--
-- 資料庫： `phpmyadmin`
--
...
('root', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"zh_TW\",\"Export\\/file_template_database\":\"__DB__-db_%Y-%m-%d\",\"Export\\/file_template_server\":\"__SERVER__-mysql_%Y-%m-%d\"}');
